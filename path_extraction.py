...
# -----------------------------
def build_dataset(qa_file, graph, output_file, max_hops=3):
    data = []
    skipped = 0
...
if __name__ == "__main__":
    ...
    QA_PATH = "Dataset/MetaQA/3-hop/vanilla/qa_train.txt"
    OUTPUT_PATH = "Dataset/MetaQA/3-hop/vanilla/train_paths.json"

    print("Carregando KG...")
    graph = load_kg(KG_PATH)

    print("Gerando dataset com paths...")
    build_dataset(QA_PATH, graph, OUTPUT_PATH)